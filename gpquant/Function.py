...
ts_AROONOSC3 = Function(
    function=_ts_AROONOSC, name="ts_AROONOSC", arity=3, is_ts=1, fixed_params=["high", "low"]
)
ts_WR4 = Function(
    function=_ts_WR, name="ts_WR", arity=4, is_ts=1, fixed_params=["high", "low", "close"]
)
ts_CCI4 = Function(
    function=_ts_CCI, name="ts_CCI", arity=4, is_ts=1, fixed_params=["high", "low", "close"]
)
ts_ATR4 = Function(
    function=_ts_ATR, name="ts_ATR", arity=4, is_ts=1, fixed_params=["high", "low", "close"]
)
ts_NATR4 = Function(
    function=_ts_NATR, name="ts_NATR", arity=4, is_ts=1, fixed_params=["high", "low", "close"]
)
ts_ADX4 = Function(
    function=_ts_ADX, name="ts_ADX", arity=4, is_ts=1, fixed_params=["high", "low", "close"]
)
ts_MFI5 = Function(
    function=_ts_MFI, name="ts_MFI", arity=5, is_ts=1, fixed_params=["high", "low", "close", "volume"]
)
